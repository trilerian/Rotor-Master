...
float VCC = 5.0000; // Arduino Voltage
float QOV1 = 2.5000;  // Quiescent Output Sensor1
float QOV2 = 2.5000;  // Quiescent Output Sensor2
float QOV3 = 2.5000;  // Quiescent Output Sensor3
float M1 = -1.0000; // Multiplier Sen1
float M2 = -1.0000; // Multiplier Sen2
float M3 = -1.0000; // Multiplier Sen3
